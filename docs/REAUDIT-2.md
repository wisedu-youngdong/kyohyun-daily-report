> **[보관용 문서]** 이 감사도 전 단계 완료됐습니다. 줄 번호·코드 인용은 2026-07-15 시점(커밋 564eb8d) 기준이라 지금 코드와 맞지 않습니다.
> 다만 **의도적으로 안 고치고 남긴 항목**이 있으니, 관련 작업 전에 확인하세요:
> - **R15** — App.jsx의 하드코딩 색상 약 140곳. 리스크 대비 우선순위가 낮아 보류(tokens.jsx로 옮기는 작업)
> - **R16** — 정사각 파비콘. 이후 중립 브랜드 마크로 대체되어 해소됨
> - 마일스톤 계산 중복 로직 공통 유틸화 — 미반영
