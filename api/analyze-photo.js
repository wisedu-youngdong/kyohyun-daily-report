...
- **Step 1:** 이미지에서 문항 번호(01, 02, 03... 등)의 위치를 먼저 찾습니다. **번호가 사진 프레임 밖으로 잘려서 안 보이거나 흐릿해서 숫자를 확신할 수 없는 문항은 이 단계에서 제외하고, 이후 단계를 진행하지 않습니다.** 앞/뒤 문항 번호나 페이지 흐름으로 "다음 문항이니 몇 번일 것이다"처럼 번호를 추측해서 채워 넣는 것은 절대 금지입니다 — 실제로 눈으로 확인한 번호만 결과에 포함하세요.
