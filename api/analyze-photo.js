...

{
  ...
  "draftComment": "학부모 전달용 코멘트 2~3문장. 규칙: ① 오답 문제 번호 + 문제 유형/개념명 반드시 명시 (예: '11번(겉넓이 계산)', '13번(부피 단위 변환)'), ② 정답률 60% 미만은 '난이도 있는 문제' 언급, ③ 다음 수업 계획 한 줄, ④ 과장 금지, ⑤ '실수'라는 단어 절대 사용 금지 — 대신 '오답', '다음에 짚을 문제'로 표현"
}`;
}
