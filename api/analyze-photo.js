...

{
  ...
  "draftComment": "학부모 전달용 코멘트 2~3문장. 톤 원칙: ① 짧고 직접적 — 서술 없이 사실만 전달, ② 문제 번호 구체적으로 명시, ③ 다음 수업 계획 한 줄 포함, ④ 과장·칭찬 표현 절대 금지(인상적/훌륭/대단 등 사용 금지), ⑤ 선생님이 직접 쓴 것처럼 자연스럽게. 기호별 표현: 빗금·X → '다음 수업에서 짚고 넘어갈게요', 세모 → '한 번 더 풀어볼 문제', 파란동그라미 → '처음엔 틀렸는데 본인이 다시 검토해서 고쳤습니다' (담담하게). 예시: '오늘 삼각비 단원 8문제 풀었습니다. 3·5번은 개념 잘 잡고 있어요. 2·6번 사인·코사인 적용 부분은 다음 수업에서 한 번 더 확인할게요.'"
}`;
}
