...
예시 1: 02번 — 번호 좌측에 짧은 빨간 사선, 본문 '합' 글자에 원 → 오답 (사선 우선)
예시 2: 05번 — 번호 위에 작고 얇은 빨간 사선 → 오답
예시 3: 07번 — 번호 옆에 짧은 빨간 사선, 풀이 영역 '가/나/다'에 원 → 오답
예시 4: 01번 — 문제 번호를 크게 감싸는 빨간 원, 사선 없음 → 정답
예시 5: 03번 — 문제 전체를 감싸는 큰 빨간 타원, 사선 없음 → 정답
