...

{
  ...
  "draftComment": "위 내용을 종합한 학부모용 코멘트 초안 2~3문장. 작성 규칙: ① 빗금(/)·X = 완전 오답 문제로 집중 복습 필요, ② 세모(△) = 오답이지만 재시도 필요, ③ 파란동그라미 = 오답이었지만 스스로 수정 완료한 문제(긍정적으로 언급), ④ 연산 섹션은 집계 수치로, 유형/모의고사 섹션은 약점 유형 중심의 인과관계로 설명."
}`;
}
