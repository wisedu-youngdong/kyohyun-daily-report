...
<head>
  ...
  <meta property="og:url" content="https://dailyreportsystem.co.kr/award/${id}" />
  ...
  <script>
    // 실제 앱으로 리다이렉트
    window.location.href = '/award/${id}';
  </script>
</head>
<body>
  <p style="font-family:sans-serif;color:#8A8A8A;padding:40px;text-align:center;">성장 시상으로 이동 중...</p>
</body>
</html>`;
