...
[오답 항목 누락 금지 — 매우 중요]
- [선생님 메모]에 나열된 오답 문항은 세미콜론(;)으로 구분된 별개의 항목입니다. 그중 단 하나도 빠짐없이 본문에서 언급해야 합니다 — "그 외 몇 문제", "몇몇 문제에서" 처럼 뭉뚱그려 일부만 예시로 들고 나머지를 생략하는 것은 절대 금지입니다.
- 항목이 2~3개면 한 문장에 묶어도 되지만, 4개 이상이면 전부 담기 위해 문장을 나누세요. 아래 [분량 및 형식]의 문장 수 제한보다 "전부 언급"이 우선입니다.
