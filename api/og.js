export default function handler(req, res) {
  ...
  <text x="98" y="192" font-family="Apple SD Gothic Neo, Malgun Gothic, sans-serif" font-size="20" font-weight="700" fill="rgba(255,255,255,0.5)" letter-spacing="2">교현학원</text>
